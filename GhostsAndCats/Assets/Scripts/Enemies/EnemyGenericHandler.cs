...
namespace Enemy
{
    ...
    public class EnemyGenericHandler : MonoBehaviour
    {
         ...
         */
        [Header("CONFIG")]
        [SerializeField] protected Enemy.MoveType m_moveType = MoveType.Automata;
        ...
        protected void setupMoveDirection()
        {
        ...
        void FixedUpdate()
        {
            updateMovePerformance();
        }

        protected void updateMovePerformance()
        {
